...
.register-container {
    width: 400px;
    padding: 20px;
    background-color: rgba(255, 255, 255, 0.2); /* Light, semi-transparent white background */
...
.register-container h1 {
    ...
    color: #f5f5f5; /* Dark heading color */
}
...
.form-group label {
    ...
    margin-bottom: 8px;
    font-weight: bold;
    color: lightcyan; /* Dark gray text color */
}
...
.but {
    width: 40%;
    padding: 10px;
    background-color: #1B1B1B; /* Blue background color */
    border: none;
    border-radius: 7px;
...
.but:hover {
    background-color: darkgrey; /* Darker blue on hover */
}

.login-link {
    margin-top: 10px;
    text-align: center;
    color: darkgray; /* Lighter text color */
}
